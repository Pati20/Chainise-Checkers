...
public class StaraPlansza {
     ...
     * @param numberOfHuans -liczba graczy
     * @param numberOfBots - liczba botów
     */
    public StaraPlansza(int planszaID, int graczID, int numberOfHuans, int numberOfBots) {
        this.planszaID = planszaID;
        this.graczIDHost = graczID;
        this.licznikLudzi++;
        this.numberOfHumans = numberOfHuans;
     ...
     void boardGenerateServer() {//FOR SERVER
